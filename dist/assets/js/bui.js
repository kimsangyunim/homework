...
(function (root, factory) {
  ...
  } else if ((typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && module.exports) {
  ...
  var defaults = {
    ...
    eventBeforeCallBack: function eventBeforeCallBack() {
      return false;
    },
    eventAfterCallBack: function eventAfterCallBack() {
      return false;
    },
    activeBeforeCallBack: function activeBeforeCallBack() {
      return false;
    },
    activeAfterCallBack: function activeAfterCallBack() {
      return false;
    },
    inactiveBeforeCallBack: function inactiveBeforeCallBack() {
      return false;
    },
    inactiveAfterCallBack: function inactiveAfterCallBack() {
      return false;
    }
  }; //
  // Methods
  ...
  function createInactiveButton(settings, toggleThis) {
    ...
    if (inactiveButton === null) {
      ...
      inactiveButton.innerHTML = settings.closeButtonText; // Append Inactive Button
  ...
  var Constructor = function Constructor(selector, options) {
    ...
    publicAPIs.active = function (toggleName) {
      active(settings, publicAPIs.myToggle[toggleName]); // console.log(this);
    ...
    var toggleActions = function toggleActions(toggleThis) {
...
(function (root, factory) {
  ...
  var actionSetup = function actionSetup(settings, toggleTarget) {
